...
const SEASON_FILES = {
  ...
  saison2: {
    'index.html': require('./assets/web/saison2/index.html'),
  }
};

export async function prepareOfflineGame(season = 'saison1') {
  const files = SEASON_FILES[season] || SEASON_FILES['saison1'];
  const base = FileSystem.documentDirectory + \`fz-web-\${season}/\`;
